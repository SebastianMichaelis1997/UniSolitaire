...
public class Client {
	public static void main(String[] args) {
		...
		do {
			System.out
					.println("Hallo und herzlich willkommen bei UNI SOLITAIRE!!!!");
			System.out
					.println("Zum Anmelden bitte 'A' eingeben, zum neu registrieren 'R' eingeben und um das Programm zu beenden 'E' eingeben.");
